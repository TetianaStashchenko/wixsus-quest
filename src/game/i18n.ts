...
export const UI: Record<Lang, Strings> = {
  uk: {
    ...
    savePlaceholder: "Твоє імʼя (для галереї світів)",
    saveBtn: '💾 Зберегти мій світ у Wix',
    savingBtn: 'Зберігаю…',
    savedOk: '✅ Світ збережено у Wix CMS!',
  ...
  en: {
    ...
    savePlaceholder: 'Your name (for the worlds gallery)',
    saveBtn: '💾 Save My World to Wix',
    savingBtn: 'Saving…',
    savedOk: '✅ World saved to Wix CMS!',
  ...
  he: {
    ...
    savePlaceholder: 'השם שלך (לגלריית העולמות)',
    saveBtn: '💾 שמור את העולם שלי ב-Wix',
    savingBtn: 'שומר…',
    savedOk: '✅ העולם נשמר ב-Wix CMS!',
